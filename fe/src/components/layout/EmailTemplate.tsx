            ...
            <Box key={template._id} sx={{ borderBottom: "1px solid #eee" }}>
              ...
              >
                <Box sx={{ flex: 1, minWidth: 0, mr: 1 }}>
                  <Typography variant="body1" fontWeight="bold" noWrap sx={{ fontSize: { xs: "0.9rem", sm: "1rem" } }}>
                    {template.name}
                  </Typography>
              ...
              <Collapse in={isOpen} timeout="auto" unmountOnExit>
                <Box sx={{ px: { xs: 1.5, sm: 2 }, pb: 2 }}>
                  <Typography variant="body2" sx={{ mb: 1, fontSize: { xs: "0.8rem", sm: "0.875rem" }, wordBreak: "break-word" }}>
                    <strong>Body:</strong> {template.body}
                  </Typography>
                  ...
                  {template.url && (
                    ...
                    >
                      <Link2 size={14} style={{ flexShrink: 0, marginTop: 2 }} /> {template.url}
                    </Typography>
                  )}
